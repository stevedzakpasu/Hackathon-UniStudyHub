...
async def download_resource(url: str):
    ...
    try:
        ...
        if downloaded_file_path:
            ...
            with open(downloaded_file_path, mode="rb") as file:
                file_content = file.read()

            # Set appropriate headers for triggering the download
            headers = {
                "Content-Disposition": f'attachment; filename="{filename}"'
            }

            # Return a Response object with the file content and headers
